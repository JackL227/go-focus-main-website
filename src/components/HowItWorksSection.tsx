...
const HowItWorksSection = () => {
  ...
  return <section id="how-it-works" className="relative py-24 overflow-hidden">
      ...
      <div ref={sectionRef} className="container-custom relative z-10 opacity-0 transition-opacity duration-700">
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {steps.map((step, index) => <div key={step.id} ref={el => stepRefs.current[index] = el} className={cn("glass-card p-8 rounded-xl opacity-0 transition-all duration-500", "hover:translate-y-[-5px] hover:shadow-xl")} style={{
        ...
        <div className="mt-20 text-center">
          <h3 className="text-2xl font-bold mb-6">Ready to optimize your appointment scheduling process? </h3>
          <p className="text-foreground/80 mb-8 max-w-2xl mx-auto">
            Book your free discovery call today and see how our AI agents can automate your sales process.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <BookingWidget variant="default" className="bg-primary hover:bg-primary/90 text-background group">
              Schedule Your Demo
            </BookingWidget>
          </div>
        </div>
