...
const TestimonialSection = () => {
  return (
    <section id="testimonials" className="section bg-gradient-to-b from-background to-background/90">
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="glass-card p-8 shadow-md relative overflow-hidden group">
            ...
            <div className="absolute -top-8 -right-8 w-16 h-16 bg-blue-100/10 rounded-full opacity-70"></div>
            
            <div className="absolute top-4 right-4 text-primary opacity-30 group-hover:scale-110 transition-transform">
              <Quote size={40} />
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-gradient-to-br from-primary/30 to-primary/30 rounded-full flex items-center justify-center text-primary font-bold">
                JT
              </div>
              <div>
                <h4 className="font-medium text-primary">James T.</h4>
                <p className="text-sm text-foreground/80">Forex Trading Mentor, 15,000+ Instagram followers</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8 shadow-md relative overflow-hidden group">
            {/* Background decoration */}
            <div className="absolute -top-8 -left-8 w-16 h-16 bg-green-100/10 rounded-full opacity-70"></div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-medium text-primary">Alex L.</h4>
                <p className="text-sm text-foreground/80">Options Trading Educator, 6-figure mentorship program</p>
              </div>
            </div>
          </div>
          ...
          <div className="glass-card p-8 shadow-md relative overflow-hidden group">
            {/* Background decoration */}
            <div className="absolute -top-8 -right-8 w-16 h-16 bg-amber-100/10 rounded-full opacity-70"></div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="font-medium text-primary">Sarah R.</h4>
                <p className="text-sm text-foreground/80">Crypto Trading Community Founder, 30K+ followers</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Results Overview */}
        <div className="bg-gradient-to-r from-primary to-primary/80 rounded-2xl p-10 shadow-lg text-background overflow-hidden relative">
          {/* Background decorative elements */}
          <div className="absolute top-0 left-0 w-full h-full opacity-10">
            <div className="absolute top-10 left-10 w-32 h-32 border-2 border-background rounded-full"></div>
            <div className="absolute bottom-10 right-10 w-48 h-48 border-2 border-background rounded-full"></div>
            <div className="absolute top-1/2 left-1/4 w-20 h-20 border-2 border-background rounded-full"></div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center relative z-10 animate-slide-in-bottom opacity-0" style={{animationFillMode: 'forwards', animationDelay: '100ms'}}>
              <div className="text-4xl font-bold mb-2 text-background">73%</div>
            ...
            <div className="text-center relative z-10 animate-slide-in-bottom opacity-0" style={{animationFillMode: 'forwards', animationDelay: '200ms'}}>
              <div className="text-4xl font-bold mb-2 text-background">20+</div>
            ...
            <div className="text-center relative z-10 animate-slide-in-bottom opacity-0" style={{animationFillMode: 'forwards', animationDelay: '300ms'}}>
              <div className="text-4xl font-bold mb-2 text-background">42%</div>
            ...
            <div className="text-center relative z-10 animate-slide-in-bottom opacity-0" style={{animationFillMode: 'forwards', animationDelay: '400ms'}}>
              <div className="text-4xl font-bold mb-2 text-background">98%</div>
