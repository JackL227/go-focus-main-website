...
// Helper function to create background particles
const createBackgroundParticles = (width: number, height: number) => {
...
const drawFlowPanel = (ctx: CanvasRenderingContext2D, width: number, height: number) => {
...
// Update and draw outcome panels
const updateAndDrawOutcomePanels = (
  ctx: CanvasRenderingContext2D,
