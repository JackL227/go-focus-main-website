...
const HeroSection = () => {
  ...
  return (
    <section 
      className="relative min-h-[80vh] flex flex-col items-center pt-20 pb-12 overflow-hidden" 
      aria-label="Hero section"
    >
      <div className="container-custom relative z-10 pt-4 flex flex-col h-full">
        <div className="flex flex-col items-center max-w-4xl mx-auto text-center mb-6">
          <div className="space-y-6 mb-6">
            <h1 aria-label="Main headline" className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-gradient-primary py-[30px]">
              AI Agents That Convert Leads Into Revenue — 
              <span className="text-primary">While You Sleep.</span>
            </h1>
            
            <p className="text-xl text-foreground/90 animate-fade-in [animation-delay:400ms]" aria-label="Subheadline">
          ...
          <div className="flex flex-col sm:flex-row gap-4 animate-fade-in [animation-delay:600ms] mb-0">
