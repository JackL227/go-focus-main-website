      ...
      <div ref={sectionRef} className="container-custom relative z-10 opacity-0 transition-opacity duration-700">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Watch How Your <span className="text-primary">AI Agent</span> Converts Leads
          </h2>
          <p className="text-lg text-foreground/80 max-w-2xl mx-auto">
            Our AI system processes inquiries 24/7, qualifying leads and booking appointments 
            automatically while you focus on delivering exceptional service.
          </p>
        </div>
